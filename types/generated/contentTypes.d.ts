...
export interface ApiContactContact extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    contact_number_1: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiFloorFloor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    floor_area: Schema.Attribute.Integer & Schema.Attribute.Required;
    floor_no: Schema.Attribute.Integer & Schema.Attribute.Required;
...
export interface ApiOwnerOwner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::owner.owner'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    ownership_type: Schema.Attribute.Enumeration<['add']>;
    phone: Schema.Attribute.BigInteger;
    property: Schema.Attribute.Relation<'oneToOne', 'api::property.property'>;
    publishedAt: Schema.Attribute.DateTime;
    spoc: Schema.Attribute.String & Schema.Attribute.DefaultTo<'NA'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPropertyContactPropertyContact
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    association_type: Schema.Attribute.Enumeration<
      ['SPOC', 'MANAGER', 'TENANT', 'OWNER', 'BUILDER']
    >;
...
export interface ApiPropertyProperty extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dock_count: Schema.Attribute.Integer;
    dock_level_ft: Schema.Attribute.Decimal;
    efficiency_percentage: Schema.Attribute.Decimal;
    ...
    type: Schema.Attribute.Enumeration<['OFFICE', 'LWS']> &
      Schema.Attribute.Required;
    type_of_building: Schema.Attribute.Enumeration<['RCC', 'PEB']>;
    type_of_floor: Schema.Attribute.Enumeration<
      ['RCC', 'VDF', 'FM II', 'Tremix']
    >;
    units: Schema.Attribute.Relation<'oneToMany', 'api::unit.unit'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiUnitContactUnitContact extends Struct.CollectionTypeSchema {
...
export interface ApiUnitUnit extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    age_of_furnishing: Schema.Attribute.Integer & Schema.Attribute.Required;
    area: Schema.Attribute.Integer & Schema.Attribute.Required;
    asking_rental_inr: Schema.Attribute.Decimal;
    availability_type: Schema.Attribute.Enumeration<
      ['LEASE', 'SALE', 'BOTH', 'NONE']
    >;
    available_for: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::unit.unit'> &
      Schema.Attribute.Private;
    parking_count: Schema.Attribute.Integer & Schema.Attribute.Required;
    ...
    unit_contacts: Schema.Attribute.Relation<
      ...
      'api::unit-contact.unit-contact'
    >;
    unit_no: Schema.Attribute.Integer;
    unit_photo: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::property-contact.property-contact': ApiPropertyContactPropertyContact;
      'api::property.property': ApiPropertyProperty;
      'api::unit-contact.unit-contact': ApiUnitContactUnitContact;
